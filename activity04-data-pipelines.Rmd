...
**Oh it shows the specifications for some of the fields as in if they are strings or doubles**:
...
**What we would need to ask is what everyone's gender is, or how they identify.  That and maybe how they they identify sexually (LGBT+)**:
...
**The major that has the lowest unemployment rate is petroleum engineering which makes sense because there is so much money in big oil**:
